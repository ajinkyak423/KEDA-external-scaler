...
type MetricSpec struct {
	...
	TargetSize float32 `protobuf:"fixed32,2,opt,name=targetSize,proto3" json:"targetSize,omitempty"`
}
...
func (x *MetricSpec) GetTargetSize() float32 {
	if x != nil {
		return x.TargetSize
	}
	return 0
...
type MetricValue struct {
	...
	MetricName  string  `protobuf:"bytes,1,opt,name=metricName,proto3" json:"metricName,omitempty"`
	MetricValue float32 `protobuf:"fixed32,2,opt,name=metricValue,proto3" json:"metricValue,omitempty"`
}
...
func (x *MetricValue) GetMetricValue() float32 {
	if x != nil {
...
var file_externalscaler_proto_rawDesc = []byte{
	...
	0x02, 0x52, 0x0a, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x7e, 0x0a,
	...
	0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0b, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63,
